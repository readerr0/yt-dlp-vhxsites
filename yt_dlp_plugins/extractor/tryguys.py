...
class TryguysIE(InfoExtractor):
    _LOGIN_URL = 'https://watch.2ndtry.tv/login'
    _NETRC_MACHINE = '2ndtry'
...
class TryguysSeasonIE(InfoExtractor):
    _PAGE_SIZE = 24
    ...
    def _fetch_page(self, url, season_id, page):
        ...
        yield from [self.url_result(item_url, TryguysIE) for item_url in traverse_obj(
